export class Clip {
  ...
  get ClipTemplate() {
    return /*html*/ `
   <div class="col-md-3" data-bs-toggle="modal" data-bs-target="#Video"  onclick="app.activesController.setActiveClip('${this.id}')">

 <div class="p-3  bg-light elevation-5  mx-4 my-2 " style="width:18rem;">
